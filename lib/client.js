...
`;
		...
		*/
		function VideoLibrary({ onClose }) {
			...
			}, "⚠ 未优化") : null, (0, react.createElement)("span", { className: "dba-badge" }, SOURCE_LABEL[v.source] ?? v.source), (0, react.createElement)("span", { className: "dba-meta" }, formatBytes(v.bytes)))), (0, react.createElement)("div", { className: "dba-dir" }, "想加自己的片子：把 mp4 放进这个文件夹，再点「刷新」", (0, react.createElement)("br", null), (0, react.createElement)("code", null, state === null ? "…" : state.userDir)), (0, react.createElement)("div", { className: "dba-bar" }, (0, react.createElement)("button", {
				type: "button",
				className: "dba-btn",
				onClick: () => void load()
		...
		*/
		...
		function apply(ctx) {
			...
			const AppRoot = () => {
				...
				return (0, react.createElement)(BootOverlay, { store });
			};
