...
`;
		...
		function BootOverlay({ store, videoSrc }) {
			ensureStyle();
		...
		*/
		function VideoLibrary({ onClose }) {
			...
			}, (0, react.createElement)("span", { className: "dba-mark" }, v.id === activeId ? "✓" : ""), (0, react.createElement)("span", { className: "dba-nm" }, v.name), v.legacy ? (0, react.createElement)("span", { className: "dba-badge" }, "原片源") : null, (0, react.createElement)("span", { className: "dba-badge" }, SOURCE_LABEL[v.source] ?? v.source), (0, react.createElement)("span", { className: "dba-meta" }, formatBytes(v.bytes)))), (0, react.createElement)("div", { className: "dba-dir" }, "想加自己的片子：把 mp4 放进这个文件夹，再点「刷新」", (0, react.createElement)("br", null), (0, react.createElement)("code", null, state === null ? "…" : state.userDir)), (0, react.createElement)("div", { className: "dba-bar" }, (0, react.createElement)("button", {
				type: "button",
				className: "dba-btn",
				onClick: () => void load()
		...
		*/
		...
		function apply(ctx) {
			...
			const AppRoot = () => {
				...
				const videoSrc = (0, react.useMemo)(() => activeId === null ? VIDEO_URL : VIDEO_URL + "#" + encodeURIComponent(activeId), [activeId]);
				if (libOpen) return (0, react.createElement)(VideoLibrary, { onClose: () => setLibOpen(false) });
